...
//               const profile = chat.profiles[0]; // Assuming the first profile is the one to display
//               const user = profile.user || {}; // Fallback to an empty object if user is undefined

//               return (
//                 <button className="call-chat-btn" onClick={() => handleChatClick(chat.id)} > 
//                   <ChatInstance
//                       key={chat.id}
//                       chat={{
...
//       <div>
//         <Chat chatId={selectedChatId} /> {/* Pass selected chat ID to Chat component */}
//       </div>
//     </div>
//   );
// }
